<x-app-layout>
  <x-slot name="header">
    <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Interview Reflection</h2>
  </x-slot>
        ...
        <div class="p-6">
          <form method="POST" action="{{ route('interviews.update', $interview) }}">
            ...
            <div class="mt-6 flex gap-3">
              ...
              <a href="{{ route('interviews.show', $interview) }}" class="px-4 py-2 bg-gray-100 rounded hover:bg-gray-200">Cancel</a>
            </div>
          </form>
        </div>
      </div>
